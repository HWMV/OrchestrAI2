                              ...
                              child: Container(
                                ...
                                child: Image.asset(
                                  ...
                                  errorBuilder: (BuildContext context, Object exception, StackTrace? stackTrace) {
                                    return Center(
                                      child: Text(
                                        crewModel.selectedAgents[index]!.name.substring(0, 1),
                                        style: TextStyle(
                                          color: Colors.black87,
                                          fontWeight: FontWeight.bold,
                                        ),
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    ...
                    padding: EdgeInsets.symmetric(vertical: 16, horizontal: 32), // 패딩 설정
                  ...
                  onPressed: () async {
                    if (activeAgents.isNotEmpty) {
                      // 팝업이 여러 번 뜨지 않도록 조건 추가
                      if (!crewModel.isPopupShown) {
                        crewModel.isPopupShown = true;
                        showDialog(
                          context: context,
                          builder: (BuildContext context) {
                          ...
                          crewModel.isPopupShown = false; // 팝업이 닫히면 상태 초기화
                        });
                      }
                    } else {
